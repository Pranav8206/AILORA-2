...
const Header = () => {
  return (
    <header className="bg-linear-to-tr from-green-600 to-green-700 sticky top-0 h-16 z-50 flex items-center justify-between px-4 py-3 shadow-lg">
      <div className="flex items-center space-x-3">
        ...
        <div>
          ...
          <p className="text-green-100 text-xs flex items-center space-x-1">
      ...
      <div className="relative">
        <MoreVertical className="w-6 h-6 text-white hover:text-green-200" />
      </div>
    </header>
  );
};
